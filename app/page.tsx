    ...
    <div className="px-4 py-6 sm:px-6 sm:py-10">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-5">
        <section className="poster-shadow poster-panel overflow-hidden rounded-[2.5rem] border border-[#172033]/20">
          <div className="grid gap-8 px-6 py-8 sm:px-10 sm:py-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p
                data-poster="true"
                className="mt-8 max-w-3xl text-3xl leading-[0.95] tracking-[0.02em] text-[#172033] sm:text-4xl"
              >
                A backyard beach-club festival built on crawfish, water, and
                summer energy.
              </p>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#24344d]">
                Bubelpalooza is the kind of day you talk yourself into once and
                then never want to miss again: poolside, flavor-forward,
                low-pressure, and alive with people, music, and good heat.
              </p>
              ...
              <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
                <div className="rounded-[1.75rem] border-2 border-[#172033]/15 bg-[#fff7e6] px-5 py-5 text-[#172033]">
                  ...
                  <p className="mt-3 text-sm leading-6">
                    Crawfish front and center, built to gather people around the
                    table.
                  </p>
                </div>
                <div className="rounded-[1.75rem] border-2 border-[#172033]/15 bg-[#fff7e6] px-5 py-5 text-[#172033]">
                  ...
                  <p className="mt-3 text-sm leading-6">
                    Poolside atmosphere that makes the whole day feel loose and
                    summery.
                  </p>
                </div>
                <div
                  id="lineup"
                  className="rounded-[1.75rem] border-2 border-[#172033]/15 bg-[#fff7e6] px-5 py-5 text-[#172033]"
                >
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#1d4ed8]">
                    Music
                  </p>
                  <p className="mt-3 text-sm leading-6">
                    A mini showcase that keeps the event buzzing without taking
        ...
        <section className="grid gap-3 md:grid-cols-4">
          <div className="rounded-[1.6rem] border-2 border-[#172033]/15 bg-[#fff7e6] px-5 py-5 text-[#172033]">
        ...
        <section
          id="experience"
          className="poster-shadow rounded-[2.25rem] border-2 border-[#172033]/18 bg-[#101827] px-6 py-8 text-[#fff7e6] sm:px-8"
        >
          <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <h2
                data-poster="true"
                className="mt-4 text-5xl leading-[0.88] tracking-[0.02em]"
              >
                ONE DAY.
                <br />
                ONE PLACE.
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-[1.6rem] border border-white/10 bg-[#172033] p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#ffd447]">
                  Boil
                </p>
                <p className="mt-3 text-sm leading-6 text-[#f7dfa5]">
                  Big flavor, easy hospitality, and the social center of the
                  whole event.
                </p>
              </div>
              <div className="rounded-[1.6rem] border border-white/10 bg-[#172033] p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[#f7dfa5]">
                  Water, sunshine, and a day-party feel that never gets too
                  rigid.
                </p>
              </div>
              <div className="rounded-[1.6rem] border border-white/10 bg-[#172033] p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[#f7dfa5]">
                  A mini showcase that keeps the atmosphere moving without
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-[1.5rem] border-2 border-[#e6392e]/20 bg-[#ffd447] p-4">
                ...
                <p className="mt-2 text-sm">
                  Quick purchase flow with easy-to-read choices.
                </p>
              </div>
              <div className="rounded-[1.5rem] border-2 border-[#2ec4f3]/25 bg-white p-4">
                ...
                <p className="mt-2 text-sm">
                  Clear details and a checkout experience guests can trust.
                </p>
              </div>
              <div className="rounded-[1.5rem] border-2 border-[#172033]/15 bg-[#fff1c7] p-4">
                ...
                <p className="mt-2 text-sm">
                  Follow-up info that helps people feel event-day ready.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="mt-4 grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            ...
            <p className="max-w-2xl text-base leading-8 text-[#344760]">
              Bubelpalooza should feel like a bold local festival flyer that
              got turned into a ticketing site without losing its personality.
              Big name. Big color. Big vibe. Crawfish, poolside fun, and live
              music all visible at once.
            </p>
          </div>
        </section>
      </div>
